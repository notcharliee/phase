...
export default () => (
  <div className="h-[calc(100vh-4rem-1px)] grid">
    <div className="place-self-center absolute opacity-0 animate-[text-fade-in_1s_2s_forwards] text-center">
      <h1 className="text-[9rem] leading-none font-black tracking-tighter">404</h1>
      <p className="text-5xl font-extrabold tracking-tighter">Not Found</p>
    </div>
    <Moon className="place-self-center animate-[moon-shrink_ease-in_1s_forwards] w-72 h-72 sm:w-80 sm:h-80 md:w-96 md:h-96" />
    <svg
      className="place-self-center animate-[moon-twinkle_1s_1s_forwards] absolute w-0 h-0"
      width="112"
      height="113"
      viewBox="0 0 112 113"
      fill="none"
